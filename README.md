...
#### Test url: https://testpg.wibmopay.com/refund
#### Live url: https://pg.wibmopay.com/refund
### Passing the parameters for checking transaction status
...
* checksum (generate checksum format ("order_id|secret" ))

The status can be one of the following:
1. On successful statuscode - 200 ("message": "Refund Initiated successfully")
2. Wrong order_id statuscode - 400 ("message": "Merchant Transaction Not Found")
3. Wrong checksum statuscode - 400 ("message": "Invalid checksum")
4. Missing order_id statuscode - 400 ("message":  "No merchant found")
